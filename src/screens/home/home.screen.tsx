    ...
    <div data-name="home" className="h-screen w-full bg-[#0a192f]">
      ...
      >
        <div className="text-center md:text-left">
          <motion.h2 className="text-4xl pt-10 pb-10 sm:text-7xl font-bold text-white" variants={textVariants}>
        ...
        <motion.div variants={imageVariants} className="mt-10 md:mt-5"> {/* Adjusted margin-top value */}
          <img
            src={me}
            alt="my profile"
