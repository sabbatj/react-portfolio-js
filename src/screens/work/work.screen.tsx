...
const Work = () => {
  return (
    <div data-name='work' className='w-full h-screen text-gray-300 bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8 pt-16 w-full flex justify-center items-center flex-col mb-4 '>
            ...
            >
              <div className='flex justify-center items-center flex-col'>
                ...
                <p className='text-center'>
                  A web application built with REACT, TYPESCRIPT, NODE.JS, TAILWINDCSS, JAVASCRIPT.
                </p>
          ...
          <div className='aspect-w-1 aspect-h-1'>
            ...
            >
              <div className='flex justify-center items-center flex-col'>
                ...
                <p className='text-center'>
                  A web application built with JAVASCRIPT, HTML, CSS, BOOTSTRAP.
                </p>
                <div className='pt-8 text-center'>
