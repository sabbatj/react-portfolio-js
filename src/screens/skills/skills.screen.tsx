    ...
    <div data-name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div className=' w-full flex justify-center items-center flex-col mb-7 mt-12'>
              ...
              <p className='py-4 text-2xl'>Proficient in a diverse range of technologies for delivering innovative solutions. Here are some of the technologies I have experience with:</p>
          </div> 
